...
// Mocking User model and bcrypt functions
const User = {
  find: sinon.stub(),
  create: sinon.stub(),
  findOne: sinon.stub(),
...
// Similarly, write tests for 'signup' and 'login' functions following a similar structure.
describe("signup function", () => {
  ...
  it("should handle signup error", async () => {
    const req = {
      body: {
        // Invalid input intentionally missing required fields
      },
    };
    const res = {
      status: sinon.stub().returnsThis(),
